...
## ライセンス
このソフトウェアは、どなたでも無償で無制限にご利用いただけます。<br>
ただし、著作権表示および本許諾表示を、<br>
ソフトウェアのすべての複製または重要な部分に記載していただく必要があります。<br>
ご利用の際は、`malken21` のクレジットを明記してください。<br>
作者または著作権者は、本ソフトウェアに関して一切の責任を負いません。<br>
このツールを改良した VR180°カメラが増えることを願っております。
